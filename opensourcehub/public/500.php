...
<h1 style="font-size:64px;margin-bottom:10px;">500</h1>
<h3 style="margin-bottom:15px;">Внутренняя ошибка сервера</h3>
<p style="color:var(--text-muted);margin-bottom:25px;">
Произошла ошибка на сервере. Попробуйте обновить страницу или зайти позже.
</p>
...
<script>
VANTA.NET({el:"body",mouseControls:true,touchControls:true,scale:1.0,color:0x6c5ce7,backgroundColor:0x06070d});
</script>
</body>
</html>
